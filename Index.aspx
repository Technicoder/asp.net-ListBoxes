...
&nbsp;
        <asp:DropDownList ID="dlTeam" runat="server" Font-Bold="True" Font-Size="Large">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:ListBox ID="lstGreenTeam" runat="server" Height="250px" Width="205px" Rows="6" SelectionMode="Multiple">
            <asp:ListItem>Peter Brown</asp:ListItem>
        </asp:ListBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:ListBox ID="lstRedTeam" runat="server" Height="250px" Width="205px" SelectionMode="Multiple">
            <asp:ListItem>Lisa Stanko</asp:ListItem>
        </asp:ListBox>
        <br />
        <br />
        <asp:Button ID="Team" runat="server" Font-Bold="True" Font-Size="Large" 
            Text="Select Team" OnClick="Team_Click" />
&nbsp;&nbsp;&nbsp;
